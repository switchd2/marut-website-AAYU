    ...
    <main className="bg-dark text-white min-h-screen flex flex-col justify-between">
      ...
      <div className="pt-28 pb-16 flex-1 max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-16">
          ...
          {/* Viewer Panel */}
          <div className="lg:col-span-8 bg-black border border-dark-border rounded-lg overflow-hidden flex flex-col justify-center items-center p-6 relative min-h-[400px]">
            {/* Visualizer Frame */}
            <div className="absolute top-4 left-4 flex items-center gap-2 bg-dark/80 px-3 py-1.5 rounded border border-dark-border z-10 font-mono text-[10px] text-yellow">
              <span className="w-1.5 h-1.5 bg-yellow rounded-full animate-ping"></span>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs font-mono">
                ...
                <tbody className="divide-y divide-dark-border/40 text-white/80">
                  {pinouts[activePort as keyof typeof pinouts].pinout.map((pinRow, idx) => (
                    <tr key={idx} className="hover:bg-dark-surface/10">
        ...
        <div className="bg-dark-card border border-dark-border rounded-lg p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="bg-dark border border-dark-border rounded p-6 flex flex-col justify-between">
                <div>
